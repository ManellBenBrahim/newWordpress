...
?>
    ...
    <main id="primary" class="site-main">
        ...
        ?>
            ...
            <?php } ?>
                        <div class="title-single-actualite"><?php echo the_title(); ?></div>
                        ...
                        <div class="tags-post">
                            <div class="tag-post bg-<?php echo getColor( $parent ); ?>">
                                <?php echo get_field( 'tag' )['label']; ?> </div>
                        </div>
                    </div>
                ...
                if ( get_row_layout() == 'texte' ) {
                  ...
                  echo $texte;
                    ...
                    foreach ( $photos as $photo ) {
                      ...
                      $size = 'galerie-size';
                      ?>
                                            <div class="col-lg-4 col-md-4 col-4 pd-0 galerie-item">
                                                <a href="#"
                ...
                <?php } elseif ( get_row_layout() == 'documents_attached' ) { ?>
                    ...
                    if ( $files ) {
                      foreach ( $files as $file ) {
                        ...
                        ?>
                                                <div class="col-lg-6 col-md-6 col-6 pd-0">
              ...
              foreach ( $contacts as $contact ) {
                if ( ( $contact->post_type == 'contact' ) && ( $contact->post_status == 'publish' ) ) {
                  ...
                  $tel   = get_field( 'telephone', $contact->ID ); ?>
                                    <div class="col-sm-4 pd-0 pd-l-45">
